...
describe('Employee e2e test', () => {
  ...
  const employeeSample = { codeEmployee: 98997 };
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="codeEmployee"]`).type('99355').should('have.value', '99355');

      cy.get(`[data-cy="name"]`).type('Borders Lane').should('have.value', 'Borders Lane');

      cy.get(`[data-cy="birthday"]`).type('2024-11-21').should('have.value', '2024-11-21');

      cy.get(`[data-cy="otherId"]`).type('markets Principal').should('have.value', 'markets Principal');

      cy.get(`[data-cy="address"]`).type('Pound').should('have.value', 'Pound');

      cy.get(`[data-cy="mobilePhone"]`).type('Developer').should('have.value', 'Developer');

      cy.get(`[data-cy="workPhone"]`).type('rich').should('have.value', 'rich');

      cy.get(`[data-cy="workEmail"]`).type('blue array').should('have.value', 'blue array');

      cy.get(`[data-cy="privateEmail"]`).type('Zambia Agent').should('have.value', 'Zambia Agent');

      cy.get(`[data-cy="department"]`).type('value-added').should('have.value', 'value-added');

      cy.get(`[data-cy="startDate"]`).type('2024-11-20').should('have.value', '2024-11-20');
