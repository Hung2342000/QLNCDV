...
describe('Report e2e test', () => {
  ...
  describe('new Report page', () => {
    ...
    it('should create an instance of Report', () => {
      cy.get(`[data-cy="ticketId"]`).type('42989').should('have.value', '42989');

      cy.get(`[data-cy="actionAudit"]`).type('Guyana').should('have.value', 'Guyana');

      cy.get(`[data-cy="action"]`).type('cross-platform Human Sum').should('have.value', 'cross-platform Human Sum');
