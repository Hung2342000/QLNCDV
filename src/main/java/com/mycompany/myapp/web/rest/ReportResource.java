...
public class ReportResource {
    ...
    public ResponseEntity<Report> partialUpdateReport(
        ...
        Optional<Report> result = reportRepository
            ...
            .map(existingReport -> {
                if (report.getTicketId() != null) {
                    existingReport.setTicketId(report.getTicketId());
                }
                if (report.getActionAudit() != null) {
                    existingReport.setActionAudit(report.getActionAudit());
                }
                if (report.getAction() != null) {
                    existingReport.setAction(report.getAction());
                }
