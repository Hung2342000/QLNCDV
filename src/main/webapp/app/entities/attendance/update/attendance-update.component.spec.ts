...
describe('Attendance Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should update editForm', () => {
      ...
      expect(comp.editForm.value).toEqual(expect.objectContaining(attendance));
    });
  });
  ...
  describe('save', () => {
    it('Should call update service on save for existing entity', () => {
      // GIVEN
      const saveSubject = new Subject<HttpResponse<Attendance>>();
      ...
      expect(attendanceService.update).toHaveBeenCalledWith(attendance);
    ...
    it('Should call create service on save for new entity', () => {
      ...
      // THEN
      expect(attendanceService.create).toHaveBeenCalledWith(attendance);
      expect(comp.isSaving).toEqual(false);
      expect(comp.previousState).toHaveBeenCalled();
    });
