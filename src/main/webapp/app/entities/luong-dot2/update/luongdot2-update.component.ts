...
@Component({
  ...
  templateUrl: './luongdot2-update.component.html',
  styleUrls: ['./luongdot2-update.component.scss'],
})
export class Luongdot2UpdateComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.activatedRoute.data.subscribe(({ luongdot2 }) => {
      this.luong = luongdot2;
    });
